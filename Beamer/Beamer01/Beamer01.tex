...
% -----------------------------------------------------
% Cores: [fg] significa cor do texto e [bg] é cor do fundo
% -----------------------------------------------------
...
\setbeamercolor{block title}{bg=meucor, fg=branco}		%Cor do título
\setbeamercolor{block body}{bg=cinzaclaro, fg=black}	%Cor do texto 
% -----------------------------------------------------
...
% -----------------------------------------------------
\usepackage{lmodern}     % mantém CM/LM Sans como fonte principal
\usepackage{tgheros}     % small caps reais
\DeclareFontFamily{T1}{lmss}{}
\DeclareFontShape{T1}{lmss}{m}{sc}{<-> s*[1.05] qhv8t}{}
% -----------------------------------------------------
...
% -----------------------------------------------------
\title{\textsc{Titulo da Apresentação}}
...
\begin{minipage}{1\linewidth}
  ...
  \begin{tabular}{cc}
    \begin{tabular}{c}
      \includegraphics[width=1.5cm]{LogoUFT.pdf}
    \end{tabular}
    &
    \begin{tabular}{c}
        \textsc{Universidade Federal do Tocantins}\\
        \textsc{Campus Universitário de Palmas}\\
        \textsc{Curso de Licenciatura em Computação}
    \end{tabular}
  \end{tabular}
\end{minipage}
...
\begin{figure}
  \centering
  \includegraphics[scale=.5]{LogoUFT.pdf}
