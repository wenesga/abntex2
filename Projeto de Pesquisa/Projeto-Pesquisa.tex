...
\usepackage{fontspec}
%\setmainfont{Libertinus Serif} % Libertinus Serif
%\setmainfont{TeX Gyre Pagella} % serifada elegante
%\setmainfont{TeX Gyre Termes} % estilo Times
%\setmainfont{TeX Gyre Heros}  % estilo Helvetica
%\setmainfont{TeX Gyre Adventor} % sans moderna
%\setmainfont{Cambria} 
\setmainfont{Calibri} 
...
\professor{Wenes Aquino}
\tutoronline{Gomes Aquino}
\tutordopolo{Aquino Gomes}
