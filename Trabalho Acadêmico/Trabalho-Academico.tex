...
%\renewcommand{\familydefault}{\sfdefault} % Sem serifa
% ===============================================
...
% -----------------------------------------------
\titulo{Modelo \abnTexUFT para\\ Trabalha de Conclusão de Curso por \WenesTex}
...
\preambulo{Trabalho de Conclusão de Curso apresentado como 
    ...
    e personalizado com ajustes estruturais, servindo também 
    para testar o espaço disponível utilizada nessa contracapa.}
% -----------------------------------------------
...
\makeatletter
\setlength{\@fptop}{5pt} % Distância da parte superior da página até o primeiro elemento flutuante.
\makeatother
% -----------------------------------------------
